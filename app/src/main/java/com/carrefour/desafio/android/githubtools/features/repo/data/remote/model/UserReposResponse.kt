package com.carrefour.desafio.android.githubtools.features.repo.data.remote.model
...
data class UserReposResponse(
    ...
    @SerializedName("homepage") val homepage: Any? = null,
    ...
    @SerializedName("license") val license: Any? = null,
